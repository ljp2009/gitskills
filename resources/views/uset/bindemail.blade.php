...
@section('formrange')
@include('partview.headerbar',['left'=>'back', 'center'=>'pageTitle', 'right'=>'home', 'pageTitle'=>'绑定邮箱'])
...
<div class="ym_cm_card" style="border-bottom:none">
        ...
        <div class="ym_fp_row">
            <input name="value" type="text" placeholder="请输入邮箱地址" value="{{$oldValue}}"/>
        </div>
        <div class="ym_fp_row">
            <input name="validate_code" type="number" placeholder="输入验证码" maxlength="4" value=""/>
    ...
    <button type="button" class="ym_fp_submit" onclick="bind()">绑定邮箱</button>
