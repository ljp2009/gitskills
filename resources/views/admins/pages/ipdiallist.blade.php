...
<div class="admin-content">
    @include('admins.partviews.titlebar',['titles'=>['数据管理', '作品', '台词']])
    <div class="am-g">
        ...
        <table class="am-table am-table-bd am-table-striped admin-content-table" style="margin-bottom:200px">
          ...
          @foreach($items as $item)
              <tr id ="row_{{$item->id}}">
                  <td>{{$item->id}}</td>
                  <td>{{$item->textPart}}</td>
                  <td style="width:120px">{{$item->rolePart}}</td>
                  ...
                  <td style="width:80px">
                      <div class="am-dropdown " data-am-dropdown>
                        ...
                        <ul class="am-dropdown-content">
                          ...
                          <li><a href="javascript:void(0)" onclick="adminDeleteItem({{$item->id}}, 'ip_dial')">删除</a></li>
                          <li><a href="javascript:void(0)" onclick="adminApproveItem({{$item->id}}, 'ip_dial')">通过</a></li>
                          <li><a href="javascript:void(0)" onclick="adminRejectItem({{$item->id}}, 'ip_dial')">拒绝</a></li>
                        </ul>
                      </div>
                  </td>
              </tr>
...
var paramsArr =  [
        {'text':'台词','name':'text', 'type':'textarea', 'value':''},
        {'text':'作者','name':'text2', 'type':'text', 'value':''},
