...
<div class="admin-content">
    ...
    <div class="am-tabs-bd">
      <form id='form1' method="post" action="/admin/act/act-result" enctype="multipart/form-data">
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-10">
                <input  name='to_date' type='date' class="am-form-field"
                    value="{{is_null($model->from_date)?date('Y-m-d'):date('Y-m-d', strtotime( $model->to_date))}}" />
              </div>
            </div>
            <div class="am-g am-margin-top">
              <div class="am-u-sm-4 am-u-md-2 am-text-right">活动结果</div>
              <div class="am-u-sm-8 am-u-md-10">
                <textarea name='result' rows='5' class="am-form-field">{{$model->result}}</textarea>
              </div>
            </div>
