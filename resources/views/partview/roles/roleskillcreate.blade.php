...
<div class="ym-g">
    <form method="post" id="pubForm" onsubmit="return validate()" action="/roleskill/create">
...
<!--                 <label>角色技能名称</label> -->
                <input name="name" class="ym-form-field" placeholder="请填写您要发布的角色技能名称..."/>
            </div>

            <div class="ym-imgfield" style="margin-bottom:1rem">
                <input name="addImg" type="hidden" value=""
            ...
            <div class="ym-form-group ym_fp_row" style="padding:0px">
                <!-- <label>请选择技能属性</label> -->
                <select name="attrcode" class="ym-form-field" style="padding: 0rem 0.6rem;font-size:1.4rem;color:#555;" >
                    <?php $i = 0 ?>
...
$('#addImg').scUploadImageWork({
   ...
   .bind('beforeUpload', function(uploadSet, params){
       ...
       console.log('imageWidth:'+uploadSet.imageSize.originWidth+';'+'imageHeight:'+uploadSet.imageSize.originHeight);
   }, null)
