			...
			<div class="am-favorite-info ym_listitem">
                ...
                <div class="ym-favorite-detail" style="z-index:0;">
                    <div class="my-score-box">
                      <span class="ym-favorite-detail-label">我的评分</span>
                    <div class="my-score-star">
                      @for($i=1; $i<=5; $i++)
                        @if(($item['score']-$i) >= 0)
                            <i class="am-icon-star ym-c-yellow"></i>
                        @else
                            <i class="am-icon-star ym-c-yellow am-icon-star-o"></i>
                        @endif
                      @endfor
                      </div>
                    </div>
                    <div class="my-score-box">
                        <span class="ym-favorite-detail-label">我贡献了</span>
                        <div class="ym-home-ip-gold">
                        {{$item['goldRecord']}}金币
                        </div>
                    </div>
                    <div class="my-score-box">
                        <span class="ym-favorite-detail-label">同好的人</span>
                        <br />
				...
				<div class="am-g">
					...
					@if(strpos($scene->image,'default')===false)
					<span><img src="{{$scene->image->getPath(1,'164w_126h_1e_1c')}}" class = "am-img-responsive" alt=""></span>
					@endif
                    </div>
					@endforeach
					@endif
