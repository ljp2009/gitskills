...
jQuery.ymImgField.makePerviewDiv = function(st){
    return $('<div class="ym-imgfield-perview" id= "ym-imgfield-pv-'+st.fieldName+'"></div>');
};
//获取预览框
...
jQuery.ymImgField.makePerviewItem = function(value, st){
    var perviewItem = $('<div flag="img-'+st.fieldName+'-'+value+'" class="ym-imgfield-perview-item"></div>');
    var imgName = value;
    ...
    var img = $('<img src="'+imgName+'" class="ym-imgfield-perview-img" style="max-width:100%"/>');
